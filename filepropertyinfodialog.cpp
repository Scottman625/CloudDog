    ...
    ui(new Ui::FilePropertyInfoDialog)
{
    ...
    QString style2 = QString("font: 14pt \"隸書\";color: rgb(255, 156, 16);");
    ...
    ui->val_download->setOpenExternalLinks(true); //label內容為超鏈結內容
}
...
void FilePropertyInfoDialog::setFileInfo(FileInfo *fileInfo)
{
    ...
    //傳一個鏈結
    //<a href="http://192.168.139.131:80/group1/M00/00/00/wKiLg1-jbP-AfQYXAABf_SnU0l4565.png">圖片1</a>
